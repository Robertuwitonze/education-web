...
<textarea class="summernote" cols="1000" rows="1000" name="postdescription" required></textarea>
</div>
</div>
</div>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Feature Image(W:772 x H:318)</b></h4>
