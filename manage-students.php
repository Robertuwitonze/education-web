...
$query=mysqli_query($con,"update tblstudents set Is_Active=0 where id='$postid'");
if($query)
{
$msg="Student deleted ";
}
...
$query=mysqli_query($con,"select tblstudents.id as sid, tblstudents.Enroll_id as id, tblstudents.names as name, tblstudents.email as email, 
                          ...
                          tblstudents.Is_Active = 1 and tblstudents.status='approved'");
...
<td><a href="edit-student.php?pid=<?php echo htmlentities($row['sid']);?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
    &nbsp;<a href="manage-students.php?pid=<?php echo htmlentities($row['sid']);?>&&action=del" onclick="return confirm('Do you realy want to delete ?')"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
 </tr>
<?php $a++;} }?>
