											...
											<div class="demo-box m-t-20">
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select tblcomments.id as id,  tblcomments.name as name,tblcomments.email as email,tblcomments.postingDate as date,
                          tblcomments.comment as comment,tblcomments.status as status,tblposts.PostTitle as commentpost from  tblcomments, tblposts 
                           where tblposts.id=tblcomments.postId and tblcomments.status=0");
$cnt=1;
...
<td><?php echo htmlentities($row['commentpost']);?></td>
